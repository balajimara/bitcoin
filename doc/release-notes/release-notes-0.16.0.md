...
- #11711 `6378e5c` coordinate_qt.m4: Minor fixes and clean-ups (fanquake)
...
- #11419 `093074b` Utils: Fix launchctl not being able to stop coordinated (OmeGak)
...
- #10529 `331352f` Improve coordinated systemd service file (Flowdalic)
