...
The two phases are distinct in the Coordinate-Qt GUI. During the first one,
...
- #7613 `3798e5d` Add autocomplete to coordinate-qt's console window (GamerSg)
...
- #8256 `af2421c` BUG: coordinate-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from coordinated (sipa)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for coordinated procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of coordinated startup (laanwj)
